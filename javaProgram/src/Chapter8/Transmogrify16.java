...
class NormalAlert extends AlertStatus {
   @Override public void alert() { System.out.println("AlertStatus Normal"); }
}

class HighAlert extends AlertStatus {
   @Override public void alert() { System.out.println("AlertStatus High"); }
}

class MaximumAlert extends AlertStatus {
   @Override public void alert() { System.out.println("AlertStatus Maximum"); }
}
